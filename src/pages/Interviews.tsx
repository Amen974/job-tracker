...
import NewAplication from "../components/ApplicationForm"
import { supabase } from "../lib/supabase"
import type { Interview } from "../types"
import ShowInterview from "../components/ShowInterview"
import EditInterview from "../components/EditInterview"
import InterviewsSkeleton from "../components/InterviewsSkeleton"
          ...
          <div className="h-full w-full flex relative">
            <div className="flex flex-col flex-wrap w-full pb-30 lg:pb-10 gap-5">
              ...
              <div className=" flex flex-col gap-5">
                ...
                {showEdit && (<EditInterview onClose={() => setShowEdit(false)} selectedInterview={selectedInterview} />)}
